    ...
    <>
      ...
      {restaurantPhone && (
        <div className="fixed bottom-6 left-4 z-50">
          ...
          <div className="absolute inset-0 animate-pulse rounded-full bg-[#25D366] opacity-50 blur-md" />
          <a
            href={`https://wa.me/55${restaurantPhone.replace(/\D/g, "")}?text=${encodeURIComponent(`Olá! Vi o cardápio de ${restaurantName} e gostaria de fazer um pedido.`)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="relative flex items-center gap-3 rounded-full bg-[#25D366] px-5 py-4 text-white shadow-2xl transition-transform hover:scale-105 active:scale-95"
